# Django settings for django_sso_secondday project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'DJANGO_SSO_SECONDDAY',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'l_tpu047^$fm6ar!n&amp;ha5odgdl2rwlz3qf4ww83y%y++x_*!g$'
...
#SESSION_COOKIE_SECURE = True  to use this run wsgi over https - https://docs.djangoproject.com/en/dev/howto/deployment/wsgi/